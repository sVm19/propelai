...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground flex flex-col items-center p-8 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-4 right-4 animate-in fade-in slide-in-from-top-4 duration-700 delay-200">
        <ModeToggle />
      </div>
      ...
      <div className="w-full max-w-2xl space-y-8">
        <div className="text-center space-y-4 pt-10">
          ...
          <h1 className="text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-foreground to-foreground/50">
            Propel Your Idea
          </h1>
        </div>

        <Card className="bg-card/40 border-border backdrop-blur-md shadow-2xl">
